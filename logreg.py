...
col_names = ["kd_diff","sig_strike_diff","total_strikes_diff","td_diff","ctrl_time_diff","height_diff","weight_diff","reach_diff","age_diff","winrate_diff","winner"]
...
X_train, X_test, y_train, y_test = tts(independent, dependent, test_size=0.25, random_state=42)
...
def predict_fight():
    ...
    featureOrder = ['kd_diff','sig_strike_diff','total_strikes_diff','td_diff','ctrl_time_diff','height_diff','weight_diff','reach_diff','age_diff','winrate_diff']
